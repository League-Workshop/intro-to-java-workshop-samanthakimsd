...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor == backgroundColor) {
			...
			scare();
			// String showScaryImage = "standardScaryPic.jpg";
		} else {
		...
		int endColor = -6422666;
		if (mouseColor == endColor) {
			System.out.println("win");
			JOptionPane.showMessageDialog(null, "YOU WINNNNNNNN!!!!!!");
		}
	}
	...
	private void scare() {
		...
		// maze = ImageIO.read(getClass().getResource("standardScaryPicture.jpg"));
